...
CREATE TABLE `competence` (
  ...
  `field_of_competence` varchar(200) NOT NULL,
...
INSERT INTO `competence` VALUES (1,'IT','Programation Backend'),(2,'IT','Database Architecture'),(3,'IT','Network Management'),(4,'UML','Schema Expert');
