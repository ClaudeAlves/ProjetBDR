...
CREATE TABLE `project_journal` (
  ...
  `timeend` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `status` varchar(45) NOT NULL,
  PRIMARY KEY (`journal_id`),
  KEY `PROJECT_TO_JOURNAL_idx` (`project_id`),
  CONSTRAINT `PROJECT_TO_JOURNAL` FOREIGN KEY (`project_id`) REFERENCES `project` (`project_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `project_journal` VALUES (1, 1, '2019-01-01 00:00:00', '2020-03-02 00:00:00', 'Cours BDR');
